...
import { ParallaxImage } from "../../src/components/landing/ParallaxImage";
  ...
  return (
    <div className="my-20">
      ...
      <div className="lg:hidden flex flex-col">
        <span className="text-gray-400 text-lg mb-6 block font-[Neue_Augenblick]">{label}</span>
        <h3 className="text-[32px] md:text-[42px] leading-[1.1] font-normal mb-10 text-black tracking-tight max-w-xl font-[Neue_Augenblick]">
          {title}
        </h3>
      ...
      <div className="hidden lg:grid grid-cols-2 gap-20">
        <div className="flex flex-col relative z-0">
          <span className="text-gray-400 text-lg mb-20 block font-[Neue_Augenblick] relative z-10">{label}</span>
          <ParallaxImage
            src={image}
            alt={imageAlt}
            yValues={yValues}
