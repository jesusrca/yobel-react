...
import svgPaths from "../../src/imports/svg-mb78q7u1ko";
import { CountryFlag } from "../../src/components/layout/CountryFlags";
    ...
    <button onClick={onContinue} className="relative rounded-[30px] shrink-0 w-full hover:opacity-80 transition-opacity" data-name="Primary">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center justify-center p-[16px] relative w-full">
          <p className="font-['Neue_Augenblick:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[18px] text-black text-center text-nowrap">Continuar en Yobel {selectedCountry}</p>
        </div>
      </div>
    </button>
  );
