...
import { beautyTexts } from "/constants/industries";
  ...
  return (
    <>
      <ScrollGradientTransition>
        {/* Hero Section */}
        <HeroGradientTall
          category={beautyTexts.hero.category}
          title={beautyTexts.hero.title}
          description={beautyTexts.hero.description}
          variant="yellow"
        />
               ...
               <div className="flex flex-col gap-12 items-center">
                 ...
                 <div>
                   <Button className="bg-transparent border-[1.5px] border-black text-black px-8 py-6 rounded-full text-xl relative overflow-hidden transition-all duration-500 before:absolute before:inset-0 before:bg-[linear-gradient(150deg,#FFF700_0%,#FFF700_32%,#FFE300_70%,#5dd3c0_100%)] before:opacity-0 before:transition-opacity before:duration-500 before:rounded-full hover:before:opacity-100 hover:border-0">
                     <span className="relative z-10">{beautyTexts.intro.button}</span>
                   </Button>
                 </div>
               </div>
             </div>
      ...
      {/* Solutions Section */}
      <InteractiveList items={beautyTexts.solutions.items} title={beautyTexts.solutions.title} />

      {/* Benefits Section */}
      <Section className="bg-white py-20">
        <Container>
          <BenefitsSection
            title={beautyTexts.benefits.title}
            image={beautyTexts.benefits.items[0] ? "assets/industrias/2_bellesa_cui-personal.jpeg" : "assets/industrias/2_bellesa_cui-personal.jpeg"}
            imageAlt="Benefits"
            benefits={beautyTexts.benefits.items}
          />
        </Container>
      </Section>
      ...
      <SolutionsShowcase
        label={beautyTexts.useCases.label}
        title={beautyTexts.useCases.title}
        solutions={beautyTexts.useCases.items}
      ...
      {/* Results Section */}
      <ResultsGrid
        label={beautyTexts.results.label}
        title={beautyTexts.results.title}
        items={beautyTexts.results.items}
      />

      {/* Certifications Section */}
      <Certificates description={beautyTexts.certifications.description} />
    </>
  );
}