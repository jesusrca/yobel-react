             ...
             <div className="flex flex-col gap-8 max-w-[1000px] mx-auto items-center text-center">
               ...
               <div className="flex flex-col gap-12 items-center">
                 <p className="text-2xl md:text-4xl lg:text-[40px] leading-tight font-normal text-black">
                   En Yobel diseñamos y operamos cadenas logísticas integradas para retail. Aseguramos disponibilidad, trazabilidad y cumplimiento, optimizando el abastecimiento de tiendas físicas, marketplaces y clientes finales.
                 </p>
                 <div>
