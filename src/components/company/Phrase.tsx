      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-4 md:px-[50px] py-0 relative w-full">
          <ScrollRevealString 
            ...
            as="p"
            className="basis-0 font-augenblick grow leading-tight md:leading-[48px] min-h-px min-w-px not-italic relative shrink-0 text-2xl md:text-[45px] text-black text-center"
          />
        </div>
      </div>
    </div>
