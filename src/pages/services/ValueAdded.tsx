...
import { valueAddedTexts } from "../../constants/services";
...
export function ValueAdded() {
  ...
  return (
    <>
      <div className="relative h-screen w-full overflow-hidden font-augenblick">
        ...
        <div className="absolute bottom-20 left-0 right-0 px-[5%] md:px-[50px] z-10">
           <div className="max-w-[1400px] mx-auto flex flex-col gap-[30px]">
              <p className="text-lg md:text-[18px] text-black">{valueAddedTexts.hero.subtitle}</p>
              <div className="flex flex-col lg:flex-row items-start gap-[40px]">
                 <h1 className="text-5xl md:text-[65px] leading-[1] text-black max-w-[773px]">
                   {valueAddedTexts.hero.title.replace('{selectedCountry}', selectedCountry)}
                 </h1>
                 <p className="text-xl md:text-[22px] leading-[24px] text-black max-w-[316px] pt-2">
                   {valueAddedTexts.hero.description}
                 </p>
              </div>
           </div>
        </div>
      ...
      <SolutionsShowcase
        label="Soluciones"
        title={valueAddedTexts.solutions.title}
        solutions={valueAddedTexts.solutions.items}
         ...
         <Container>
            <div className="flex flex-col lg:flex-row gap-16 items-center">
               <div className="w-full lg:w-1/2">
                  <div className="mb-6">
                     ...
                     <h2 className="text-4xl md:text-5xl lg:text-[45px] leading-tight font-normal">
                        {valueAddedTexts.benefits.title}
                     </h2>
                  </div>
               ...
               <div className="w-full lg:w-1/2 flex flex-col gap-10">
                  {valueAddedTexts.benefits.items.map((benefit, idx) => (
      ...
      <Section className="bg-white py-20 overflow-hidden relative">
         <Container className="relative z-10" ref={containerRef}>
            ...
            <div className="flex flex-col w-full">
               ...
               {valueAddedTexts.processes.items.map((step, idx) => (
      ...
      {/* FAQ Section */}
      <FAQ items={valueAddedTexts.faqs} />
    </>
  );
}