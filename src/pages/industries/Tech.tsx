...
const solutions = [
  {
    ...
    fullDesc: "Infraestructura con sistemas de acceso restringido, monitoreo 24/7 y control estricto de humedad y temperatura para componentes sensibles."
  },
  {
    id: "02",
    title: "Distribución Tecnológica",
    fullDesc: "Abastecimiento a retail, canales corporativos y clientes finales con trazabilidad total y medidas de seguridad reforzadas."
  },
  {
    id: "03",
    title: "Valor Agregado (VAS)",
    fullDesc: "Etiquetado, armado de kits tecnológicos, carga de software, reacondicionado y empaques promocionales personalizados."
  },
  {
    id: "04",
    title: "Transporte Especializado",
    fullDesc: "Unidades equipadas con suspensión neumática y GPS dedicadas al traslado seguro de equipos delicados o de alto valor."
  },
  {
    id: "05",
    title: "Comercio Exterior",
    fullDesc: "Coordinación integral de importaciones, exportaciones y nacionalización de dispositivos electrónicos para lanzamientos sincronizados."
  }
];
...
const useCases = [
  { number: "01", title: "Lanzamientos tecnológicos", desc: "Distribución nacional sincronizada para asegurar disponibilidad en la fecha clave." },
  { number: "02", title: "Reposición de retail", desc: "Abastecimiento continuo de tiendas y mayoristas según rotación." },
  { number: "03", title: "E-commerce electrónico", desc: "Preparación y despacho de pedidos online con empaque seguro." },
  { number: "04", title: "Kitting corporativo", desc: "Armado de paquetes tecnológicos (laptop + accesorios) para empresas." },
  { number: "05", title: "Transporte de valor", desc: "Traslado seguro con escolta y monitoreo para equipos de alto costo." }
];
...
export function Tech() {
  ...
  return (
    <>
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col gap-[30px]">
             ...
             <div className="flex flex-col lg:flex-row items-start gap-[40px]">
                <h1 className="text-5xl md:text-[65px] leading-[1] text-black max-w-[900px]">
                  Soluciones logísticas para Tecnología
                </h1>
                <p className="text-xl md:text-[22px] leading-[24px] text-black max-w-[400px] pt-2">
                  Movemos innovación con precisión, seguridad y trazabilidad en cada entrega.
                </p>
             </div>
          </div>
        </div>
           ...
           <div className="flex flex-col gap-8 max-w-[1000px] mx-auto items-center text-center">
             ...
             <div className="flex flex-col gap-12 items-center">
               <p className="text-2xl md:text-4xl lg:text-[40px] leading-tight font-normal text-black">
                 En Yobel SCM gestionamos la cadena logística de equipos tecnológicos y de alto valor. Ofrecemos almacenamiento seguro, transporte especializado y distribución omnicanal, garantizando la integridad del producto.
               </p>
               <div>
           ...
           <div className="flex flex-col gap-12">
             ...
             <div className="flex flex-col lg:flex-row gap-16 items-center">
                ...
                <div className="w-full lg:w-1/2 relative h-[600px] rounded-[30px] overflow-hidden">
                   <img 
                     src="https://images.unsplash.com/photo-1724526788521-b1da0cfc1aea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJvbmljcyUyMHdhcmVob3VzZSUyMHRlY2hub2xvZ3klMjBtYW51ZmFjdHVyaW5nfGVufDF8fHx8MTc2NDQxNTM5M3ww&ixlib=rb-4.1.0&q=80&w=1080" 
                     alt="Tech Industry" 
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
               <div className="w-full lg:w-1/2">
                  ...
                  <div className="mt-12 relative h-[400px] rounded-[20px] overflow-hidden hidden lg:block">
                     <img 
                       src="https://images.unsplash.com/photo-1588732283387-96e6650e7fae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21wdXRlciUyMGNoaXBzJTIwc2VjdXJlJTIwdHJhbnNwb3J0JTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NjQ0MTUzOTV8MA&ixlib=rb-4.1.0&q=80&w=1080" 
                       alt="Benefits" 
                       className="absolute inset-0 w-full h-full object-cover" 
                     />
                  </div>
      ...
      <Certificates description="Respaldamos cada operación con certificaciones internacionales de la más alta calidad." />
    </>
  );
}