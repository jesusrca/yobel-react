             ...
             <div className="flex flex-col gap-8 max-w-[1000px] mx-auto items-center text-center">
               ...
               <div className="flex flex-col gap-12 items-center">
                 <p className="text-2xl md:text-4xl lg:text-[40px] leading-tight font-normal text-black">
                   En Yobel gestionamos la logística de productos químicos bajo normativas HSE rigurosas. Contamos con infraestructura especializada, transporte habilitado y controles que aseguran la seguridad en cada etapa de la cadena.
                 </p>
                 <div>
