             ...
             <div className="flex flex-col gap-8 max-w-[1000px] mx-auto items-center text-center">
               ...
               <div className="flex flex-col gap-12 items-center">
                 <p className="text-2xl md:text-4xl lg:text-[40px] leading-tight font-normal text-black">
                   En Yobel SCM gestionamos la logística de marcas de moda y textiles con tecnología avanzada. Desde el almacenamiento clasificado por SKU hasta la distribución omnicanal, aseguramos la integridad de cada prenda en toda la cadena.
                 </p>
                 <div>
