...
const solutions = [
  {
    ...
    fullDesc: "Administramos inventarios directamente en obra o en nuestras instalaciones, con tecnología WMS y control de materiales por lote o proyecto."
  },
  {
    id: "02",
    title: "Distribución Programada",
    fullDesc: "Planificamos rutas y entregas según cronograma de obra, evitando demoras y sobrecostos logísticos innecesarios."
  },
  {
    id: "03",
    title: "Courier Técnico",
    fullDesc: "Entregas urgentes de muestras, planos o piezas críticas con trazabilidad en tiempo real para no detener la operación."
  },
  {
    id: "04",
    title: "Valor Agregado (VAS)",
    fullDesc: "Kitting y armado de kits de instalación o mantenimiento listos para uso inmediato en el punto de montaje."
  },
  {
    id: "05",
    title: "Comercio Exterior",
    fullDesc: "Coordinamos importación y despacho de maquinaria, insumos y materiales especializados desde cualquier parte del mundo."
  }
];
...
const useCases = [
  { number: "01", title: "Abastecimiento por fases", desc: "Entregas programadas de materiales estrictamente según el avance de la obra." },
  { number: "02", title: "Repuestos críticos", desc: "Servicio de courier urgente con trazabilidad total para maquinaria detenida." },
  { number: "03", title: "Control de herramientas", desc: "Registro, monitoreo y rotación eficiente de activos en campo." },
  { number: "04", title: "Kits de instalación", desc: "Armado y envío de componentes agrupados por lote o punto de montaje." },
  { number: "05", title: "Gestión de importaciones", desc: "Coordinación logística integral de maquinaria o insumos especializados." }
];
...
export function Construction() {
  ...
  return (
    <>
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col gap-[30px]">
             ...
             <div className="flex flex-col lg:flex-row items-start gap-[40px]">
                <h1 className="text-5xl md:text-[65px] leading-[1] text-black max-w-[900px]">
                  Soluciones logísticas para la Construcción
                </h1>
                <p className="text-xl md:text-[22px] leading-[24px] text-black max-w-[400px] pt-2">
                  Abastecemos tus proyectos con eficiencia, control y visibilidad total.
                </p>
             </div>
          </div>
        </div>
           ...
           <div className="flex flex-col gap-8 max-w-[1000px] mx-auto items-center text-center">
             ...
             <div className="flex flex-col gap-12 items-center">
               <p className="text-2xl md:text-4xl lg:text-[40px] leading-tight font-normal text-black">
                 En Yobel SCM gestionamos la cadena de suministro de materiales, repuestos y equipos para obras de construcción e infraestructura. Optimizamos tiempos y recursos con soluciones que integran almacenamiento y distribución.
               </p>
               <div>
           ...
           <div className="flex flex-col gap-12">
             ...
             <div className="flex flex-col lg:flex-row gap-16 items-center">
                ...
                <div className="w-full lg:w-1/2 relative h-[600px] rounded-[30px] overflow-hidden">
                   <img 
                     src="https://images.unsplash.com/photo-1763665814842-f2526387dfb4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjBtYXRlcmlhbHMlMjBsb2dpc3RpY3MlMjB3YXJlaG91c2V8ZW58MXx8fHwxNzY0NDE1MDY5fDA&ixlib=rb-4.1.0&q=80&w=1080" 
               ...
               <div className="w-full lg:w-1/2">
                  <div className="mb-6">
                     ...
                     <h2 className="text-4xl md:text-5xl lg:text-[45px] leading-tight font-normal">
                        Optimizamos tiempos y recursos en obra
                     </h2>
                  </div>
                  <div className="mt-12 relative h-[400px] rounded-[20px] overflow-hidden hidden lg:block">
                     <img 
                       src="https://images.unsplash.com/photo-1763665814546-27c2c003317e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWF2eSUyMG1hY2hpbmVyeSUyMHRyYW5zcG9ydCUyMGxvZ2lzdGljc3xlbnwxfHx8fDE3NjQ0MTUwNzR8MA&ixlib=rb-4.1.0&q=80&w=1080" 
                       alt="Benefits" 
                       className="absolute inset-0 w-full h-full object-cover" 
                     />
                  </div>
      ...
      <Certificates description="Garantizamos excelencia y seguridad con certificaciones reconocidas internacionalmente." />
    </>
  );
}