...
const solutions = [
  {
    ...
    fullDesc: "Gestión centralizada de inventario por tienda, canal o marketplace con tecnología WMS para asegurar disponibilidad en tiempo real."
  },
  {
    id: "02",
    title: "Distribución Nacional",
    fullDesc: "Abastecimiento de tiendas, supermercados y entregas directas al cliente final con trazabilidad 24/7 y cumplimiento estricto de ventanas horarias."
  },
  {
    id: "03",
    title: "Valor Agregado (VAS)",
    fullDesc: "Etiquetado, armado de combos, empaques promocionales y preparación personalizada según los requerimientos de cada canal de venta."
  },
  {
    id: "04",
    title: "Fulfillment E-commerce",
    fullDesc: "Preparación, empaque y despacho ágil de pedidos online con integración directa a tu plataforma digital (Shopify, VTEX, Magento, etc.)."
  },
  {
    id: "05",
    title: "Comercio Exterior",
    fullDesc: "Gestión de importaciones, despacho aduanero y transporte internacional de mercancías retail para asegurar el stock de temporada."
  }
];
...
const useCases = [
  { number: "01", title: "Reposición de tiendas", desc: "Entregas programadas y optimizadas según la demanda de cada punto de venta." },
  { number: "02", title: "Fulfillment e-commerce", desc: "Procesamiento y despacho rápido de pedidos en línea para mejorar la experiencia del cliente." },
  { number: "03", title: "Campañas y promociones", desc: "Kitting, empaques promocionales y distribución nacional para fechas clave (Cyber, Black Friday)." },
  { number: "04", title: "Gestión de devoluciones", desc: "Logística inversa eficiente con control de calidad y reacondicionado para reventa." },
  { number: "05", title: "Integración de canales", desc: "Flujo unificado entre retail físico y digital para una visión única del inventario." }
];
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col gap-[30px]">
             ...
             <div className="flex flex-col lg:flex-row items-start gap-[40px]">
                <h1 className="text-5xl md:text-[65px] leading-[1] text-black max-w-[900px]">
                  Soluciones logísticas para Retail
                </h1>
                <p className="text-xl md:text-[22px] leading-[24px] text-black max-w-[400px] pt-2">
                  Conectamos tu inventario con cada punto de venta, canal y consumidor final.
                </p>
             </div>
          </div>
        </div>
           ...
           <div className="flex flex-col gap-12">
             ...
             <div className="flex flex-col lg:flex-row gap-16 items-center">
                ...
                <div className="w-full lg:w-1/2 relative h-[600px] rounded-[30px] overflow-hidden">
                   <img 
                     src="https://images.unsplash.com/photo-1671427478482-2968e71a6311?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRhaWwlMjBzdG9yZSUyMHxvZ2lzdGljcyUyMHdhcmVob3VzZSUyMHNob3BwaW5nfGVufDF8fHx8MTc2NDQxNTM4NXww&ixlib=rb-4.1.0&q=80&w=1080" 
                     alt="Retail Industry" 
               ...
               <div className="w-full lg:w-1/2">
                  <div className="mb-6">
                     ...
                     <h2 className="text-4xl md:text-5xl lg:text-[45px] leading-tight font-normal">
                        Disponibilidad, eficiencia y experiencia
                     </h2>
                  </div>
                  <div className="mt-12 relative h-[400px] rounded-[20px] overflow-hidden hidden lg:block">
                     <img 
                       src="https://images.unsplash.com/photo-1664455340023-214c33a9d0bd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjBkZWxpdmVyeSUyMHBhY2thZ2VzJTIwb25saW5lJTIwc2hvcHBpbmd8ZW58MXx8fHwxNzY0NDE1Mzg4fDA&ixlib=rb-4.1.0&q=80&w=1080" 
                       alt="Benefits" 
                       className="absolute inset-0 w-full h-full object-cover" 
                     />
                  </div>
         ...
         <Container>
            <div className="flex flex-col gap-12 text-center mb-20">
               ...
               <p className="text-xl md:text-[25px] font-light leading-relaxed text-gray-800 max-w-3xl mx-auto">
                  Operamos con certificaciones internacionales que garantizan calidad, seguridad y sostenibilidad en cada etapa.
               </p>
            </div>
