...
const solutions = [
  {
    id: "01",
    title: "Manufactura",
    fullDesc: "Procesamos, envasamos y reacondicionamos productos alimenticios y bebidas bajo control sanitario, cumpliendo normas de inocuidad y trazabilidad por lote."
  },
  {
    id: "02",
    title: "Almacenamiento Frío",
    fullDesc: "Contamos con zonas de refrigeración, cuarentena sanitaria y WMS avanzado para monitoreo en tiempo real de la cadena de frío."
  },
  {
    id: "03",
    title: "Valor Agregado (VAS)",
    fullDesc: "Servicios de reempaque, etiquetado nutricional, armado de packs y promociones con control por lote y auditoría."
  },
  {
    id: "04",
    title: "Distribución",
    fullDesc: "Rutas optimizadas para productos perecibles, con entregas programadas B2B y B2C en todo el país, asegurando la integridad del producto."
  },
  {
    id: "05",
    title: "Comercio Exterior",
    fullDesc: "Gestión integral de importación/exportación, trámites aduaneros y nacionalización de materias primas y productos terminados."
  }
];
...
const useCases = [
  { number: "01", title: "Lanzamientos estacionales", desc: "Kitting y distribución nacional para nuevas líneas o promociones." },
  { number: "02", title: "Re-etiquetado sanitario", desc: "Adaptación de etiquetas según normativa local o por canal." },
  { number: "03", title: "Promociones y packs", desc: "Armado de combos con control por lote y tiempo de vigencia." },
  { number: "04", title: "Reabastecimiento retail", desc: "Entregas programadas a autoservicios, mayoristas y farmacias." },
  { number: "05", title: "Gestión de devoluciones", desc: "Procesos de control y disposición segura de productos fuera de estándar." }
];
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col gap-[30px]">
             ...
             <div className="flex flex-col lg:flex-row items-start gap-[40px]">
                <h1 className="text-5xl md:text-[65px] leading-[1] text-black max-w-[900px]">
                  Soluciones logísticas para Alimentos y Bebidas
                </h1>
                <p className="text-xl md:text-[22px] leading-[24px] text-black max-w-[400px] pt-2">
                  Movemos tu cadena de suministro con seguridad, trazabilidad y cumplimiento sanitario.
                </p>
             </div>
          </div>
        </div>
           ...
           <div className="flex flex-col gap-12">
             ...
             <div className="flex flex-col lg:flex-row gap-16 items-center">
                ...
                <div className="w-full lg:w-1/2 relative h-[600px] rounded-[30px] overflow-hidden">
                   <img 
                     src="https://images.unsplash.com/photo-1698474922963-a091a8fb4e95?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb29kJTIwYmV2ZXJhZ2UlMjBwcm9kdWN0aW9uJTIwbGluZSUyMHdhcmVob3VzZXxlbnwxfHx8fDE3NjQ0MTI3MTB8MA&ixlib=rb-4.1.0&q=80&w=1080" 
                     alt="Food Industry" 
         ...
         <Container>
            <div className="flex flex-col gap-12 text-center mb-20">
               ...
               <p className="text-xl md:text-[25px] font-light leading-relaxed text-gray-800 max-w-3xl mx-auto">
                  Contamos con certificaciones internacionales que garantizan excelencia operativa y seguridad alimentaria.
               </p>
            </div>
