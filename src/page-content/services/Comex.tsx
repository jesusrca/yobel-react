...
const comexImage = heroImage;
const hoverImage = heroImage;
const truckImage = heroImage;
const yellowTruck = heroImage;
const warehouseImage = heroImage;
