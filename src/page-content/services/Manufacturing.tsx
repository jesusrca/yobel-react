...
// Placeholder images (replace with production assets as needed)
const manufacturingPlaceholder = "https://images.unsplash.com/photo-1581091012184-5c9af7a4780f?auto=format&fit=crop&w=1200&q=80";
const imgImage2 = manufacturingPlaceholder;
const imgFrame121 = manufacturingPlaceholder;
const imgRectangle58 = manufacturingPlaceholder;

// Industry Images
const img2BellesaCuiPersonal1 = manufacturingPlaceholder;
const img2BellesaCuiPersonal2 = manufacturingPlaceholder;
const img2BellesaCuiPersonal3 = manufacturingPlaceholder;
const img2BellesaCuiPersonal4 = manufacturingPlaceholder;
const img2BellesaCuiPersonal5 = manufacturingPlaceholder;
const img2BellesaCuiPersonal6 = manufacturingPlaceholder;
const img2BellesaCuiPersonal7 = manufacturingPlaceholder;
const img2BellesaCuiPersonal8 = manufacturingPlaceholder;
const img2BellesaCuiPersonal9 = manufacturingPlaceholder;
const img2BellesaCuiPersonal10 = manufacturingPlaceholder;

// Certificates
const imgLogoInvimaYobelScmPeruLogistica = manufacturingPlaceholder;
const imgLogoBpmYobelScmPeruLogistica = manufacturingPlaceholder;
const imgLogoIsoYobelScmPeruLogistica = manufacturingPlaceholder;
const imgLogoBpaYobelScmPeruLogistica = manufacturingPlaceholder;
const imgLogoOliverYobelScmPeruLogistica = manufacturingPlaceholder;
