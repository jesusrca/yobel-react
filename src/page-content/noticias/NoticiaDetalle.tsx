...
const coverImage = "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1200&q=80";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center space-y-4">
          <p className="text-2xl font-[Neue_Augenblick]">Noticia no encontrada</p>
          <Link href="/noticias" className="text-[#59c1e6] underline">
            Volver a noticias
          </Link>
        </div>
      </div>
