import svgPaths from "./svg-rwuvz9bqrv";
...
export default function Primary() {
  return (
    <div className="relative rounded-[18.582px] size-full" data-name="Primary">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[12px] items-center justify-center px-[13.937px] py-[8px] relative size-full">
          <p className="font-['Neue_Augenblick:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[22px] text-black text-center text-nowrap whitespace-pre">Label</p>
          <ArrowRight />
        </div>
      </div>
    </div>
